...
public class MascotaController {
    ...
    @Operation(summary = "Ver recetas de mi mascota", description = "Devuelve las recetas de una mascota del usuario autenticado")
    public ResponseEntity<List<RecetaResponse>> obtenerRecetasDeMiMascota(@PathVariable Long id) {
        try {
            // Verifica permisos de acceso a la mascota
            mascotaService.obtenerMascotaPorId(id);
            List<RecetaResponse> recetas = recetaService.obtenerRecetasPorMascota(id);
